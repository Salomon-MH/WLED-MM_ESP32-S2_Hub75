# WLED MoonModules - ESP32 S2 Mini (WEMOS) build for Hub75 support

## Wiring

<img width="400" alt="wiring" src="ESP32-S2-PinOut-Hub75_WithPlugs.jpg">

As you can see, I have basically used all pins of the ESP32 S2 Mini to get Hub75 support to work. To be able to remove the ESP for patching, I have used 3 separate plugs/sockets soldered to the ESP:
- 2-Wire connector for GND & 5V in
- 6-Wire connector for A-D, OE and CLK
- 7-Wire connector for LAT and all color signals

Feel free to adapt to your liking. This is how I have it and how this branch is configured for.

## LED Hardware & 3D Models

I am using a Waveshare LED Hub75 Matrix M2.5 64x32.  
For this matrix there was no 3D model online to print as a back case and put the ESP with wiring in, so I made my own.  
Check out the `3D-Print` directory for the model.

I ended up using the thin version of the model due to time constraints and I feel like this is totally sufficient for my needs.
